...
function ColorPicker({ bannerColor, setBannerColor }) {
  return (
    <fieldset className="color-picker">
      ...
      <label className="color-picker__label" title="Make your Banner Red">
        <input
          ...
          onChange={() => setBannerColor("red")}
        />
        <div className="color-picker__swatch color-picker__swatch_red"></div>
        Red
      </label>

      <label className="color-picker__label" title="Make your Banner Blue">
        <input
          className="color-picker__color"
          type="radio"
          name="color"
          ...
          onChange={() => setBannerColor("blue")}
        />
        <div className="color-picker__swatch color-picker__swatch_blue"></div>
        Blue
      </label>

      <label className="color-picker__label" title="Make your Banner Green">
        <input
          className="color-picker__color"
          type="radio"
          name="color"
          ...
          onChange={() => setBannerColor("green")}
        />
        <div className="color-picker__swatch color-picker__swatch_green"></div>
        Green
      </label>

      <label className="color-picker__label" title="Make your Banner Gold">
        <input
          className="color-picker__color"
          type="radio"
          name="color"
